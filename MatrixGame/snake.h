...
void readButton(){
  ...
  if (keyA.readEvent(850, 950) == SHORT_PRESS && direction != DIR_LEFT){
      direction = DIR_LEFT;
  }else if (keyB.readEvent(650, 800) == SHORT_PRESS && direction != DIR_FORWARD){
      direction = DIR_FORWARD;
  }else if (keyC.readEvent(480, 650) == SHORT_PRESS && direction != DIR_RIGHT){
     direction = DIR_RIGHT;
  }else if (keyD.readEvent(250, 450) == SHORT_PRESS && direction != DIR_BACK){
     direction = DIR_BACK;
  }
}
